...
import com.ipsos.cd.selenium.helpers.FileHelpers;
...
import static com.ipsos.cd.selenium.constants.FrameworkConstants.EXPORT_VIDEO_PATH;
    ...
    public static void setAllureEnvironmentInformation() {
        AllureEnvironmentWriter.allureEnvironmentWriter(
                ImmutableMap.<String, String>builder().
                        put("Test URL", FrameworkConstants.CD_MEMBER_URL).
