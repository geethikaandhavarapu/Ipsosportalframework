...
package com.ipsos.cd.selenium.driver;

import com.ipsos.cd.selenium.constants.FrameworkConstants;
import com.ipsos.cd.selenium.enums.Target;
import com.ipsos.cd.selenium.exceptions.TargetNotValidException;
...
public class TargetFactory {
    ...
    private RemoteWebDriver createRemoteInstance(MutableCapabilities capability) {
        ...
        try {
            ...
            String gridURL = String.format("https://%s:%s@%s/wd/hub", FrameworkConstants.REMOTE_GRID_USER_NAME, FrameworkConstants.REMOTE_GRID_PASSCODE, FrameworkConstants.REMOTE_URL);
